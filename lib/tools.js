...
export const TOOLS = [
    {
        name: 'save_memory',
        description:
            'Save an important fact, preference, or upcoming event about the user for future reference. Use this when the user shares personal information, preferences, goals, habits, or mentions upcoming plans/events (even casually like "I have a basketball game Friday"). For events, always include an eventDate and tag with "event".',
        input_schema: {
            type: 'object',
            properties: {
                content: {
                ...
                eventDate: {
                    type: 'string',
                    description: 'Optional ISO 8601 date for events/plans. Use this when the user mentions something happening on a specific day, e.g. "this Friday" or "next Tuesday".',
                },
            },
            required: ['content'],
        },
    ...
    },
    {
        ...
        input_schema: {
            ...
            properties: {
                ...
                eventDate: {
                    type: 'string',
                    description: 'Optional ISO 8601 date to set or update the event date on this memory.',
                },
            },
