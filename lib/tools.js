...
export const TOOLS = [
    ...
    },
    {
        ...
        description:
            'Save a shared memory/note for a group you are in. Use this when something said in conversation is relevant to the whole group (e.g. group goals, plans, inside jokes, decisions). Only works if the user is a member of the group.',
        input_schema: {
            type: 'object',
            properties: {
                groupId: {
