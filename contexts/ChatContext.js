...
export function ChatProvider({ children }) {
    ...
    const buildSystemPrompt = useCallback(() => {
        ...
        prompt += `\n\n🔍 MANDATORY: You MUST use web_search for ANY question about real-time or current facts. This includes: sports schedules/scores/results, news, weather, prices, stock prices, release dates, event times, or anything that changes over time. Your training data is STALE — NEVER answer these from memory. ALWAYS search first. If you catch yourself about to answer a factual question without searching, STOP and search instead.`;
