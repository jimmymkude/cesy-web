...
export function ChatProvider({ children }) {
    ...
    const buildSystemPrompt = useCallback(() => {
        ...
        prompt += `\n\nWhen the user wants to buy items on Amazon, use ONE web_search call to find ALL items together. Example query: "best budget yoga mat ASIN site:amazon.com, best resistance bands ASIN site:amazon.com, best foam roller ASIN site:amazon.com". Look for /dp/XXXXXXXXXX URLs in the results to extract 10-character ASINs. Then make ONE amazon_cart call with all items. NEVER search items individually — always batch into a single search to save time and cost.`;
